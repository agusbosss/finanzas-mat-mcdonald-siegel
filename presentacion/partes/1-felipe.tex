...
\begin{frame}{¿Por qué $\alpha_v < \mu$? La analogía del dividendo}
  ...
  \begin{itemize}
    \item El retorno total de equilibrio es \az{$\mu$}; como parte llega en
          forma de dividendo (\az{$\delta > 0$}), el valor latente se aprecia
          más lento: \rj{$\alpha_v < \mu$}.
    \item Si fuese \az{$\alpha_v \geq \mu$}, esperar siempre convendría: el
          valor de la opción \resultado{divergiría a infinito} y la firma
          jamás invertiría.
  \end{itemize}
\end{frame}
