...
\begin{frame}{Los asteriscos de la Tabla IV}
  ...
  \az{$\alpha_v$} (Jensen) y \az{$\hat{\alpha}_v$} (CAPM). En la celda
...
\begin{frame}{Conclusiones}
  ...
  \begin{enumerate}
    \item \textbf{MBG}: plausible para valores presentes; con payouts y
          varianzas dependientes de los precios, las opciones serían
          menores.
    \item \textbf{Inversión indivisible}: si se pudiera invertir
          gradualmente, el problema del timing perdería importancia.
    \item \textbf{Irreversibilidad total}: se ignora el desarme posterior
...
% OJO: la slide de limitaciones se solapa con "Conclusiones" de Agustín
%      (inversión indivisible, MBG, irreversibilidad) → NOTAS-CONFLICTOS.md
% ============================================================
