...
% ============================================================
% E1 — hoja de ruta del desarrollo (OJO: se solapa con el Sumario de Felipe)
\begin{frame}{El desarrollo en tres pasos}
...
\begin{frame}{El exponente $\varepsilon$}
  ...
  \par\vspace{4mm}
  La condición $\az{\alpha_v} < \az{\mu}$ garantiza $\rj{\varepsilon} > 1$, y por
  lo tanto $\rj{C^*} > 1$.
\end{frame}
...
\begin{frame}{Apéndice: la ecuación característica}
  ...
  característica (A.4):
  \begin{ec}
    \rj{\mu} = \az{\tfrac12\, b\,(b-1)\,\sigma^2 + b\,\alpha_v + (1-b)\,\alpha_f}
  \end{ec}
...
\begin{frame}{El umbral óptimo $C^* = \varepsilon/(\varepsilon-1)$}
  ...
  \begin{ec}
    \az{\frac{dX}{dC^*}} = 0 \;\;\Longrightarrow\;\;
    \az{(1-\varepsilon)\,C^* + \varepsilon} = 0
    \;\;\Longrightarrow\;\;
    \rj{C^*} = \rj{\frac{\varepsilon}{\varepsilon-1}}
  \end{ec}
